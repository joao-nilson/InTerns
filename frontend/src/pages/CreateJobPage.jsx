...
import { ArrowLeft, Briefcase, Building2, MapPin, CheckCircle, DollarSign, Plus, Save } from 'lucide-react';
import { Input } from '../components/ui/Input';
import { Tag } from '../components/ui/Tag';

export const CreateJobPage = ({ onBack, onSave }) => {
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mb-4">Adicione as tags que aparecerão no card da vaga.</p>
                    <div className="flex gap-2 mb-4 items-end">
                        <div className="flex-grow">
                            <input 
                                ...
                                placeholder="Ex: Java 8, SQL, Pandas..."
                                value={tagInput}
